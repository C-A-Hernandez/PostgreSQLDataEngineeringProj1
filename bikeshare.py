#refactor: Indented code on line 40 moved to left
#border and new code added to line 258 and 260.
#
#This code change was done to improve the bikeshare.py
#program and also to meet the requirements of the
#GitHub project required by Udacity.
...
def user_stats(df):
    ...
    try:
        ...
        print ("\n Counts of User Types not available.")
